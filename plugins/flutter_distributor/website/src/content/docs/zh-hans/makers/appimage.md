...
- `locate`
  ...
  ```
- [AppImageTool](https://github.com/KUAILESHANGWEI/FlClash/releases/tag/third-party-appimagekit-continuous)

要安装 Appimage Builder，请运行：

```bash
wget -O appimagetool "https://github.com/KUAILESHANGWEI/FlClash/releases/download/third-party-appimagekit-continuous/appimagetool-x86_64.AppImage"
