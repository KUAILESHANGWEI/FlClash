...
func DefaultRawConfig() *RawConfig {
	return &RawConfig{
		...
		GeoXUrl: RawGeoXUrl{
			Mmdb:    "https://github.com/KUAILESHANGWEI/FlClash/releases/download/third-party-meta-rules-dat-latest/geoip.metadb",
			ASN:     "https://github.com/KUAILESHANGWEI/FlClash/releases/download/third-party-meta-rules-dat-latest/GeoLite2-ASN.mmdb",
			GeoIp:   "https://github.com/KUAILESHANGWEI/FlClash/releases/download/third-party-meta-rules-dat-latest/geoip.dat",
			GeoSite: "https://github.com/KUAILESHANGWEI/FlClash/releases/download/third-party-meta-rules-dat-latest/geosite.dat",
		},
		Sniffer: RawSniffer{
			Enable:          false,
		...
		ExternalUIURL: "https://github.com/KUAILESHANGWEI/FlClash/releases/download/third-party-metacubexd-gh-pages/metacubexd-gh-pages.zip",
